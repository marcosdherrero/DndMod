...
public abstract class IIngredientRenderer<T> {
    /**
     ...
     * @since 9.3.0
     */
    void render(MatrixStack stack, T ingredient) {
     ...
     */
    abstract List<Text> getTooltip(T ingredient, TooltipContext tooltipFlag);
     ...
     */
    TextRenderer getFontRenderer(MinecraftClient minecraft, T ingredient) {
        return minecraft.textRenderer;
    }

    public abstract java.util.List<net.minecraft.text.Text> getTooltip(FluidStack fluidStack, TooltipContext tooltipFlag);
    ...
    void render(MatrixStack stack, int xPosition, int yPosition, @Nullable T ingredient) {
